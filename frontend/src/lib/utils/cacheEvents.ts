...
const INVALIDATION_MAP: Record<CacheEventType, string[]> = {
  ...
  'file.uploaded': ['files.tree.workspace', 'ingestion.list'],
  'file.deleted': ['files.tree.workspace', 'ingestion.list'],
  'file.moved': ['files.tree.workspace'],
  'file.renamed': ['files.tree.workspace', 'ingestion.list'],
