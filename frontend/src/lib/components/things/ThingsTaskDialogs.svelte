<script lang="ts">
  ...
  export let trashTask: ThingsTask | null = null;
...
<AlertDialog bind:open={showDueDialog}>
  <AlertDialogContent class="task-due-dialog">
    ...
    <AlertDialogFooter>
      ...
      <AlertDialogAction onclick={onSaveDue} disabled={!dueDateValue}>
        Save
      </AlertDialogAction>
    </AlertDialogFooter>
  </AlertDialogContent>
...
<AlertDialog bind:open={showMoveDialog}>
  <AlertDialogContent class="task-move-dialog">
    ...
    <AlertDialogFooter>
      ...
      <AlertDialogAction onclick={onCommitMove} disabled={!moveListId}>
        Move
      </AlertDialogAction>
    </AlertDialogFooter>
  </AlertDialogContent>
