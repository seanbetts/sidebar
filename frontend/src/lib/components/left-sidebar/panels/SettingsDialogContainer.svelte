<script lang="ts">
	...
	async function loadSkills() {
		...
		try {
			...
			skillsError =
				error instanceof Error && error.message ? error.message : 'Failed to load skills.';
		} finally {
	...
	async function saveSettings() {
		...
		try {
			...
			settingsError =
				error instanceof Error && error.message ? error.message : 'Failed to save settings.';
		} finally {
	...
	async function uploadProfileImage(file: File) {
		...
		try {
			...
			profileImageError =
				error instanceof Error && error.message ? error.message : 'Failed to upload profile image.';
		} finally {
	...
	async function deleteProfileImage() {
		...
		try {
			...
			profileImageError =
				error instanceof Error && error.message ? error.message : 'Failed to delete profile image.';
		} finally {
			isUploadingProfileImage = false;
		}
	}
