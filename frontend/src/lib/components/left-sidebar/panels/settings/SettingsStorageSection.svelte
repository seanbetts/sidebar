...
<div class="settings-form">
	<div class="cache-stats">
		...
		<p>
			Oldest cache: <strong>{(cacheStats.oldestAge / 1000 / 60).toFixed(0)} minutes ago</strong>
		</p>
	</div>
...
<DeleteDialogController bind:this={deleteDialog} itemType="cache" onConfirm={handleClearCache} />
