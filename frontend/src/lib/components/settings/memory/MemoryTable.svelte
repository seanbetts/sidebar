...
<style>
  ...
  .memory-table-wrapper
    :global([data-slot='table-body'] [data-slot='table-cell']:first-child) {
    font-weight: 600;
  ...
  .memory-table-wrapper
    :global([data-slot='table-body'] [data-slot='table-cell']:nth-child(2)) {
  ...
  .memory-table-wrapper
    :global([data-slot='table-cell']:nth-child(3)),
  .memory-table-wrapper
    :global([data-slot='table-cell']:nth-child(4)),
  .memory-table-wrapper
    :global([data-slot='table-head']:nth-child(3)),
  .memory-table-wrapper
    :global([data-slot='table-head']:nth-child(4)) {
    width: 64px;
    min-width: 64px;
    text-align: center;
  ...
  .memory-table-wrapper
    :global([data-slot='table-cell']:nth-child(2)),
  .memory-table-wrapper
    :global([data-slot='table-head']:nth-child(2)) {
    width: 96px;
  }
